...
import in.alertmeu.a4b.activity.AdsRePostPreviewActivity;
...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View view, ViewGroup parent) {
        ...
        if (!detailInfo.getImage_path().equals("")) {
          ...
          //  Picasso.with(context).load(detailInfo.getImage_path()).noPlaceholder().into((ImageView) viewHolderChild.subimage);
    ...
    public View getGroupView(int groupPosition, boolean isLastChild, View view,
        ...
        if (!headerInfo.getImage_path().equals("")) {
            //Picasso.with(context).load(headerInfo.getImage_path()).noPlaceholder().into((ImageView) viewHolderMain.mimage);
