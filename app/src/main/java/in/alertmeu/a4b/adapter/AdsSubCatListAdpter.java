...
public class AdsSubCatListAdpter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdsSubCatListAdpter(Context context, List<SubCatModeDAO> data) {
