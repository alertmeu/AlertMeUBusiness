...
public class Config {
    ...
    public static final String URL_INSERTBUSINESSSHARECOUNTBAPP = BASE_URL + "user/insertBusinessShareCountBApp";
    public static final String URL_INSERTBUSINESSSHARECOUNTUAPP = BASE_URL + "user/insertBusinessShareCountUApp";
    public static final String URL_GETREVIEWBUSINESSAVGBYBID = BASE_URL + "user/getReviewBusinessAvgByBid";
    public static final String URL_GETALLREVIEWBUSINESSID = BASE_URL + "user/getAllReviewBusinessId";
    public static final String URL_ADDUSERBUSTOUSERINAPPROPRIATE = BASE_URL + "user/addUserBusToUserInappropriate";
    public static final String URL_GETALLSUBCATBUSINESSID = BASE_URL + "user/getAllSubCatBusinessId";
    public static final String URL_ADDNEWMAINPRICELISTBYBUSINESS = BASE_URL + "user/addNewMainPriceListByBusiness";
    public static final String URL_GETALLMAINPRICELISTBYBID = BASE_URL + "user/getAllMainPriceListByBid";
    public static final String URL_ADDREQUESTATTACHMENTPR = BASE_URL + "user/addRequestAttachmentPR";
    public static final String URL_GETALLSUBPRICELISTBUSINESSID = BASE_URL + "user/getAllSubPriceListBusinessId";
    public static final String URL_UPDATENEWMAINPRICELISTBYBUSINESS = BASE_URL + "user/updateNewMainPriceListByBusiness";
    public static final String URL_DELETENEWMAINPRICELISTBYBUSINESS = BASE_URL + "user/deleteNewMainPriceListByBusiness";
    public static final String URL_DELETESUBMAINPRICELISTBYBUSINESS = BASE_URL + "user/deleteSubMainPriceListByBusiness";
    public static final String URL_UPDATEREQUESTATTACHMENTPR = BASE_URL + "user/updateRequestAttachmentPR";
    public static final String URL_DELETESUBMAINIMAGEBYBUSINESS = BASE_URL + "user/deleteSubMainImageByBusiness";
    public static final String URL_GETCOUNTFEEDBACKBID = BASE_URL + "user/getCountFeedbackBid";
    public static final String URL_UPDATEFEEDBACKREADBYBUSINESS = BASE_URL + "user/updateFeedbackReadByBusiness";
    public static final String URL_UGACCOUBUSIN = BASE_URL + "user/uGAccouBusin";
    public static final String URL_GETALLADSIMAGES = BASE_URL + "user/getallAdsImages";
