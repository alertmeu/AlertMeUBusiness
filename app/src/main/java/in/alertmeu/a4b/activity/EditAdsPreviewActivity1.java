...
public class EditAdsPreviewActivity1 extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    GoogleMap googleMap;
    ...
    String tunit = "", tunit1 = "", stime = "", sdate = "", tsign = "", edate = "", etime = "", rq_code = "", main_cat = "", main_cat1 = "", subcatname = "", bar_code = "", n_flag = "0", s_flag = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s_flag = intent.getStringExtra("s_flag");
        bc_id = intent.getStringExtra("bc_id");
        sub_id = intent.getStringExtra("subcatid");
   ...
   /*     try {
        ...
        if (fileName.contains(Config.URL_AlertMeUImage)) {
            //  Picasso.with(EditAdsPreviewActivity.this).load(preferences.getString("image_path", "")).noPlaceholder().into((ImageView) imageView);
            try {
        ...
        try {
            ...
            if (filePath.contains("http")) {
                ...
                filePath = getPathFromUri(EditAdsPreviewActivity1.this, mArrayUri.get(0));
                BitmapFactory.Options options = new BitmapFactory.Options();
                options.inPreferredConfig = Bitmap.Config.ARGB_8888;
            ...
            public void onClick(View v) {
                if (AppStatus.getInstance(getApplicationContext()).isOnline()) {
                    ...
                    if (d1.compareTo(d2) > 0 && !tunit.equals("1")) {
                        Toast.makeText(EditAdsPreviewActivity1.this, res.getString(R.string.jfads), Toast.LENGTH_LONG).show();
                    } else {
                        AlertDialog.Builder builder = new AlertDialog.Builder(EditAdsPreviewActivity1.this);
        ...
        if (checkPlayServices()) {
            ...
            if (!AppUtils.isLocationEnabled(EditAdsPreviewActivity1.this)) {
                // notify user
                AlertDialog.Builder dialog = new AlertDialog.Builder(EditAdsPreviewActivity1.this);
            ...
            Toast.makeText(EditAdsPreviewActivity1.this, "Location not supported in this device", Toast.LENGTH_SHORT).show();
        }
    ...
    /*    if (AppStatus.getInstance(getApplicationContext()).isOnline()) {
        ...
        addMoney.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(EditAdsPreviewActivity1.this, MyAccountActivity.class);
    ...
    public void onConnected(Bundle bundle) {
        if (ActivityCompat.checkSelfPermission(EditAdsPreviewActivity1.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(EditAdsPreviewActivity1.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            // TODO: Consider calling
            //    ActivityCompat#requestPermissions
            // here to request the missing permissions, and then overriding
            //   public void onRequestPermissionsResult(int requestCode, String[] permissions,
    ...
    protected synchronized void buildGoogleApiClient() {
        mGoogleApiClient = new GoogleApiClient.Builder(EditAdsPreviewActivity1.this)
    ...
    private boolean checkPlayServices() {
        int resultCode = GooglePlayServicesUtil.isGooglePlayServicesAvailable(EditAdsPreviewActivity1.this);
        if (resultCode != ConnectionResult.SUCCESS) {
            if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
                GooglePlayServicesUtil.getErrorDialog(resultCode, EditAdsPreviewActivity1.this,
    ...
    private void changeMap(Location location) {
        ...
        if (googleMap != null) {
            ...
            Toast.makeText(EditAdsPreviewActivity1.this,
    ...
    private class addLocationDataDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(EditAdsPreviewActivity1.this);
                        ...
                        if (status) {
                            ...
                            for (i = 0; i < subCatArrayList.size(); i++) {
                                ...
                                try {
                                    ...
                                    jsonObjectSync.put("business_main_category_id", bc_id);
                                    jsonObjectSync.put("business_subcategory_id", sub_id);
                                                        ...
                                                        if (syncDataesponse.compareTo("") == 0) {
                                                            ...
                                                            try {
                                                                ...
                                                                if (status) {
                                                                    ...
                                                                    Toast.makeText(EditAdsPreviewActivity1.this, res.getString(R.string.jdus), Toast.LENGTH_SHORT).show();
                                                                }
    ...
    class ImageUploadTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
            dialog = ProgressDialog.show(EditAdsPreviewActivity1.this, "", res.getString(R.string.jpw), true);
            dialog.show();
        }
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                File f = CompressFile.getCompressedImageFile(file, EditAdsPreviewActivity1.this);
    ...
    private class dueFeesAvailable extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            // Create a progressdialog
            mProgressDialog1 = new ProgressDialog(EditAdsPreviewActivity1.this);
            // Set progressdialog title
