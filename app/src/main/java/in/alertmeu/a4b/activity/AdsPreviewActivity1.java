...
public class AdsPreviewActivity1 extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    GoogleMap googleMap;
    ...
    String tunit = "", tunit1 = "", stime = "", sdate = "", tsign = "", edate = "", etime = "", rq_code = "", main_cat = "", main_cat1 = "", subcatname = "", bar_code = "", nflag = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            filePath = getPathFromUri(AdsPreviewActivity1.this, mArrayUri.get(0));
            //filePath = getRealPathFromUri(mArrayUri.get(0));
            ...
            public void onClick(View v) {
                if (AppStatus.getInstance(getApplicationContext()).isOnline()) {
                    ...
                    if (d1.compareTo(d2) > 0 && !tunit.equals("1")) {
                        Toast.makeText(AdsPreviewActivity1.this, res.getString(R.string.jfads), Toast.LENGTH_LONG).show();
                    } else {
                        AlertDialog.Builder builder = new AlertDialog.Builder(AdsPreviewActivity1.this);
        ...
        if (checkPlayServices()) {
            ...
            if (!AppUtils.isLocationEnabled(AdsPreviewActivity1.this)) {
                // notify user
                AlertDialog.Builder dialog = new AlertDialog.Builder(AdsPreviewActivity1.this);
            ...
            Toast.makeText(AdsPreviewActivity1.this, "Location not supported in this device", Toast.LENGTH_SHORT).show();
        }
        ...
        addMoney.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdsPreviewActivity1.this, MyAccountActivity.class);
    ...
    public void onConnected(Bundle bundle) {
        if (ActivityCompat.checkSelfPermission(AdsPreviewActivity1.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(AdsPreviewActivity1.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            // TODO: Consider calling
            //    ActivityCompat#requestPermissions
            // here to request the missing permissions, and then overriding
            //   public void onRequestPermissionsResult(int requestCode, String[] permissions,
    ...
    protected synchronized void buildGoogleApiClient() {
        mGoogleApiClient = new GoogleApiClient.Builder(AdsPreviewActivity1.this)
    ...
    private boolean checkPlayServices() {
        int resultCode = GooglePlayServicesUtil.isGooglePlayServicesAvailable(AdsPreviewActivity1.this);
        if (resultCode != ConnectionResult.SUCCESS) {
            if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
                GooglePlayServicesUtil.getErrorDialog(resultCode, AdsPreviewActivity1.this,
    ...
    private void changeMap(Location location) {
        ...
        if (googleMap != null) {
            ...
            Toast.makeText(AdsPreviewActivity1.this,
    ...
    class ImageUploadTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
            dialog = ProgressDialog.show(AdsPreviewActivity1.this, "", res.getString(R.string.jpw), true);
            dialog.show();
        }
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                File f = CompressFile.getCompressedImageFile(file, AdsPreviewActivity1.this);
    ...
    private class dueFeesAvailable extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            // Create a progressdialog
            mProgressDialog1 = new ProgressDialog(AdsPreviewActivity1.this);
            // Set progressdialog title
